...
import Styles from './myRide.module.css'
            ...
            { isPending ? "loading ....." :
                allRide.map((item, index) => {
                    ...
                    return (
                        ...
                        <div className={Styles.outerContainer} onClick={() => {router.push(`/myRides/[detailspage_myride]`)}}>
                            {/*  */}
                            <div className={Styles.topcontainer}>
                                <div className={Styles.statusText}>
                                    status
                                </div>
                                <div className={Styles.dateText}>{<FormattedDate date = {new Date(item.date)}/>}</div>
                            </div>
